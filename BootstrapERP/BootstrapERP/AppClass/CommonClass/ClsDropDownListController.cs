...
namespace BootstrapERP.AppClass.CommonClass
{
    public class ClsDropDownListController
    {
        ...
        //public DataTable LoadDropDownList(DataTable dt, string displayMember, string valueMember)
        //{
            
        //    try
        //    {
        //        DataTable readyTable = new DataTable();
        //        if (dt.Rows.Count > 0)
        //        {
        //            dropDownListName.Items.Insert(0, new ListItem("--- Please Select ---", "-1"));
        //            foreach (DataRow dr in dt.Rows)
        ...
        public static void LoadCheckBoxListExceptConcatenation(string connectionString, string sqlQueryString, CheckBoxList checkBoxName, string displayMember, string valueMember)
        {
            DataSet ds = new DataSet();
            SqlConnection connection = new SqlConnection(connectionString);
            try
