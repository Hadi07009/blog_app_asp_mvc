...
{
    public class PremierListController : Controller
    {
        // GET: PremierList
        ...
        public ActionResult Index()
        {
            try
            {
                ...
                DataTable dtContent = _objSiteContentAccessController.ShowdBlogsForPremier(_objsiteApplicationSetup,
                ...
                var queryActionType = _objdbERPSolutionEntities.blogActionTypes.Where(a =>  (a.ActionTypeID == "P" || a.ActionTypeID == "M")).Select(c => new { c.ActionTypeID, c.ActionTypeTitle });
            ...
            , string BlogActionType)
        {
            try
            {
                ...
                else if (actionSearch != null)
                {
                    ...
                    DataTable dtContent = _objSiteContentAccessController.GetBlogForPremier(_objsiteApplicationSetup,
