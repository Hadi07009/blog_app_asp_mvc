...
namespace BootstrapERP.Models
{
    public class NodeList
    {
        ...
        public string ControllerTitle { get => _controllerTitle; set => _controllerTitle = value; }
        public string ActionTitle { get => _actionTitle; set => _actionTitle = value; }

        private string _controllerTitle;
